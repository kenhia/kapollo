...
//!
//! Promoted from the 003 spike (`spike-support::coords`). Content rows are
//! expressed as absolute scrollback indices; the grid render layer maps these to
//! `StableRowIndex` once the engine is wired (T013+).
